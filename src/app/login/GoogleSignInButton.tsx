...
export default function GoogleSignInButton() {
  return (
    <button
      ...
      className="flex items-center gap-2 rounded-md border border-neutral-300 px-4 py-2.5 text-sm font-medium text-neutral-700 hover:bg-neutral-50"
    >
      <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
        ...
        <path
          fill="#34A853"
          d="M9 18c2.43 0 4.47-.8 5.96-2.19l-2.92-2.26c-.81.54-1.85.87-3.04.87-2.34 0-4.32-1.58-5.03-3.7H.96v2.33A9 9 0 0 0 9 18Z"
        />
        <path
          fill="#FBBC05"
